...
#define _nstates5	11	/* teste */
#define minseq5	95
#define maxseq5	104
#define _endstate5	10

#define _nstates4	12	/* desc */
#define minseq4	84
#define maxseq4	94
#define _endstate4	11

#define _nstates3	7	/* sinc2 */
#define minseq3	78
#define maxseq3	83
#define _endstate3	6

#define _nstates2	7	/* sinc1 */
#define minseq2	72
#define maxseq2	77
#define _endstate2	6
...
#define Pfram_rx	((P1 *)_this)
typedef struct P1 { /* fram_rx */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, cnt) - 1*sizeof(int))

#define Pfram_tx	((P0 *)_this)
typedef struct P0 { /* fram_tx */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, cnt) - 1*sizeof(int))
